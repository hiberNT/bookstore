...
class CategoryViewSet(APITestCase):
    ...
    def test_create_category(self): #criando nova categoria
        ...
        created_category = Category.objects.get(title="technology")# aqui o teste para confirmar que crou a categoria

        self.assertEqual(created_category.title, "technology") #testando se foi a mesma informação q passamos